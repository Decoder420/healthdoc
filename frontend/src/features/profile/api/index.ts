...
const PROFILE_SEEDS: Record<string, ProfileSeed> = {
  ...
  "dev-radiology": {
    ...
    address: "9 Imaging Wing, Pune",
    emergencyContactName: "Sonal Kapoor",
    emergencyContactPhone: "+91 99887 77001",
    photo: "",
    preferences: { ...sharedPreferences, smsNotifications: true },
  },
  "dev-admin": {
