      ...
      <Table>
        ...
        <TableBody>
          {reports.map((item) => (
            ...
            >
              <TableCell>{item.report.reportNo}</TableCell>
              ...
              <TableCell>{item.patient.uhid}</TableCell>

              <TableCell>{item.report.testName}</TableCell>

              <TableCell>{item.sample.barcode}</TableCell>

              <TableCell>{item.report.verifiedBy}</TableCell>

              <TableCell>{item.report.verifiedDate}</TableCell>
