    ...
    <div className="d-flex align-items-center">
      <button
        ...
        style={
          {
            "--bs-btn-color": "#001F54",
            "--bs-btn-border-color": "#001F54",
            "--bs-btn-hover-bg": "#001F54",
            "--bs-btn-hover-border-color": "#001F54",
            "--bs-btn-hover-color": "#fff",
            "--bs-btn-active-bg": "#001F54",
            "--bs-btn-active-border-color": "#001F54",
  ...
  >
      ...
      >
        {filteredPatients.map((item: any) => (
          <button
            ...
            className="btn btn-light text-start border-bottom rounded-0 p-3"
            onClick={() =>
    ...
    <div className="d-flex align-items-center gap-3">
      ...
      <div className="dropdown">
        <button
          className="btn btn-light border rounded-pill dropdown-toggle d-flex align-items-center gap-2 px-3"
